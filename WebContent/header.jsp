...
<%@ page import="com.javaproject.service.impl.*, com.javaproject.service.*"%>
...
<body style="background-color:#E6F9E6;">
	...
	<div class="container-fluid text-center"
		 style="margin-top: 50px; margin-bottom: 50px; background-color: #16361f; color: white; padding: 20px;">
		<h1><span class="glyphicon glyphicon-leaf"></span> Nature's Pantry</h1>
		<h4>Bringing Nature's Bounty to Your Table</h4>
		<form class="form-inline" action="index.jsp" method="get">
			<div class="input-group">
				<input type="text" class="form-control" size="70" name="search" placeholder="Search Items" required>
				<div class="input-group-btn">
					<input type="submit" class="btn btn-success" value="Search" />
				</div>
			</div>
		</form>
		<p align="center" style="color: blue; font-weight: bold; margin-top: 10px; margin-bottom: 10px;" id="message"></p>
	</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="index.jsp?type=dairy">Dairy</a></li>
							<li><a href="index.jsp?type=bakedgoods">Bread and Baked Goods</a></li>
							<li><a href="index.jsp?type=frozenitems">Frozen Items</a></li>
