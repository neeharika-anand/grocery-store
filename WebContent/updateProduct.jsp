				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="dairy"
								<%="dairy".equalsIgnoreCase(ptype) ? "selected" : ""%>>Dairy</option>
							<option value="bakedgoods"
								<%="bakedgoods".equalsIgnoreCase(ptype) ? "selected" : ""%>>Bread and Baked Goods</option>
							<option value="frozenitems"
								<%="frozenitems".equalsIgnoreCase(ptype) ? "selected" : ""%>>Frozen Items</option>
							<option value="snacks"
