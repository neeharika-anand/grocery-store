...
<%@ page
		import="com.javaproject.service.impl.*, com.javaproject.service.*,com.javaproject.Model.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="row text-center">
		...
		<div class="col-sm-4" style='height: 350px;'>
			<div class="thumbnail">
				...
				<form method="post">
					<%
						if (userType != null && userType.equals("admin")) { // Admin actions
					%>
					<button type="submit" formaction="removeProduct.jsp?pid=<%=product.getProdId()%>" class="btn btn-danger">Remove Product</button>
					<button type="submit" formaction="updateProduct.jsp?pid=<%=product.getProdId()%>" class="btn btn-primary">Update Product</button>
					<%
