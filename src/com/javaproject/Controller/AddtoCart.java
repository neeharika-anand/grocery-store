...
import com.javaproject.service.impl.CartServiceImpl;
import com.javaproject.service.impl.DemandServiceImpl;
...
public class AddtoCart extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (pQty == cartQty) {
			...
			if (flag)
				status += "<br/>Later, We will notify you via email when " + product.getProdName()
						+ " will be available in the stock";
